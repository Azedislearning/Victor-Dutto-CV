This is my curriculum, based on the AltaCv template
I kept the Cvtag and cvsection command (in altacv cls)
I added the usage of smartdiagrams (in skills)
I used a combination of cvtag (which looks very handsome in my opinion)
and the fontawesome lib in tools
Kept the date format in all the history (left) part
